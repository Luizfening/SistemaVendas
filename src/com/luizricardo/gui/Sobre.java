...
public class Sobre extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lbIcone.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/luizricardo/gui/img/sobre.png"))); // NOI18N
        ...
        taTexto.setRows(5);
        taTexto.setText("Sistema de Vendas\nAutor: Luiz Ricardo Oliveira\nE-mail: feninglol@gmail.com\n\nAplicação desenvolvida para uso próprio,\nsem fins lucrativos.");
